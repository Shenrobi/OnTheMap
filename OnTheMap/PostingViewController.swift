...
class PostingViewController: UIViewController {
    ...
    private func configureUI(_ state: UIState, location: CLLocationCoordinate2D? = nil) {
        ...
        case .Find:
            ...
            middleSection.backgroundColor = UIColor(hex: 0x02B3E4)
            bottomSection.backgroundColor = UIColor(hex: 0x02B3E4)
            cancelButton.setTitleColor(UIColor(hex: 0x007AFF), for: .normal)
            findButton.setTitleColor(UIColor.white, for: .normal)
            locationTextField.layer.borderColor = UIColor(hex: 0x02B3E4).cgColor
            mediaURLTextField.layer.borderColor = UIColor(hex: 0x02B3E4).cgColor
            
        case .Submit:
            setHiddenElements(true)
            topSection.backgroundColor = UIColor(hex: 0x02B3E4)
